const CACHE='extraok-v1';
const ASSETS=['./','./index.html','./styles.css','./src/app.mjs','./src/core.mjs','./src/crypto.mjs','./src/store.mjs','./src/license.mjs','./manifest.webmanifest','./assets/icon.svg','./privacy.html','./terms.html'];
