...
function pricingMarkup() {
  return `<div class="section-heading"><div><span class="eyebrow">Simple ownership</span><h2>Start free, own the tool, or have us set it up.</h2><p>No auto-renewal, per-envelope fee, ads, or sale of project data.</p></div></div><div class="price-grid"><article class="price-card"><h3>Free</h3><div class="price">$0</div><ul><li>Up to 3 pending approvals</li><li>Private review links</li><li>Signed decision receipts</li><li>Print and JSON backup</li></ul><a class="button ghost" href="#new">Use free</a></article><article class="price-card featured"><h3>Pro Lifetime</h3><div class="price">$19 <small>one time</small></div><ul><li>Unlimited approval records</li><li>Lifetime access to this edition</li><li>Offline install</li><li>License recovery support</li></ul><a class="button secondary" href="${PURCHASE_URL}" target="_blank" rel="noopener">Buy Pro — $19</a><a class="button ghost compact" href="#license">Activate a license</a><p class="muted">Signed license delivery to your checkout email follows payment verification, normally within one business day.</p></article><article class="price-card"><h3>Done-for-you setup</h3><div class="price">$500 <small>flat</small></div><ul><li>One current change-order template converted</li><li>Scope, price, and schedule fields configured</li><li>Signed-decision receipt workflow</li><li>Pro Lifetime license included</li><li>Delivery within 48 hours after receiving the template</li></ul><a class="button secondary" href="mailto:helpinghandschitown@gmail.com?subject=ExtraOK%20workflow%20setup%20%E2%80%94%20%24500">Start a $500 setup</a><p class="muted">Email the template or a redacted sample. We confirm fit and send a Stripe checkout before work begins. No meeting or subscription required.</p></article></div>`;
}
